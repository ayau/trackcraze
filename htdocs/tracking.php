...
<div id="main">
            ...
            <input type='text' class='searchtracki' value="" autocomplete='off' placeholder='Search who you are tracking'/><div id='searchtrack' class='search sp'></div><div class='errortrack'></div>
            <br /><br /><br />
<?php
...
echo "<p class='h3'>Tracking</p><table border='0'><tr><td>Top Tracks</td><td></td></tr>";
list($string, $search)=$users->getTracking($cuser);
echo $string;
  ...
  <span></span>
           ...
           $(".searchtracki").autocomplete({
       		...
       		$("#searchtrack").live("click",function(){
   				...
   				if (found==false){
   					$(".errortrack").show();//MAKE IT SHOW!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   					$(".errortrack").text("This person is not in your tracking list");
