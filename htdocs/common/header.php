...
<html xmlns="http://www.w3.org/1999/xhtml">
	<?php
	if (!isset($_SESSION['LoggedIn'])&&substr($_SERVER['REQUEST_URI'],0,10)!="/login.php"&&substr($_SERVER['REQUEST_URI'],0,11)!="/signup.php"&&substr($_SERVER['REQUEST_URI'],0,18)!="/accountverify.php"&&substr($_SERVER['REQUEST_URI'],0,13)!="/password.php"&&substr($_SERVER['REQUEST_URI'],0,21)!="/passwordretrieve.php"&&substr($_SERVER['REQUEST_URI'],0,21)!="/retrievepassword.php"&&substr($_SERVER['REQUEST_URI'],0,12)!="/theteam.php"&&substr($_SERVER['REQUEST_URI'],0,13)!="/timeline.php"&&substr($_SERVER['REQUEST_URI'],0,12)!="/contact.php"&&substr($_SERVER['REQUEST_URI'],0,18)!="/privacypolicy.php"&&substr($_SERVER['REQUEST_URI'],0,10)!="/terms.php"&&substr($_SERVER['REQUEST_URI'],0,13)!="/feedback.php" && substr($_SERVER['REQUEST_URI'],0,13)!="/tutorial.php"):
